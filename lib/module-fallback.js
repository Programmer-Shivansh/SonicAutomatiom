...
export const toHex = (value) =>
  typeof value === "string" && value.startsWith("0x") ? value : "0x0";
...
export const readContract = () =>
  Promise.resolve(HARDCODED_VALUES.tokenBalance);
...
export const providers = {
  Web3Provider: class MockProvider {
    constructor() {}
    getBalance() {
      return Promise.resolve(HARDCODED_VALUES.nativeBalance);
    }
  },
};
...
export const ethers = {
  ...
  Contract: class MockContract {
    constructor() {}
    balanceOf() {
      return Promise.resolve(HARDCODED_VALUES.tokenBalance);
    }
  },
  BigNumber: {
